...
LaundryConfig.WashTime = 5

-- temps pour augmenter le nombre de vêtement sale dans le bac de linge sale (par défaut de 2) temps en seconde
LaundryConfig.DirtyClothDelay = 2

-- How many dirty clothes can be in the dirty clothes cart at most (default: 20)
LaundryConfig.DirtyCartMaxCloth = 120

-- How much money will anyone earn per clean cloth (default: 10)
LaundryConfig.MoneyPerCloth = 1000
